...
class LecturePage extends StatefulWidget {
  @override
  _LecturePage createState() => new _LecturePage();
}

class _LecturePage extends State<LecturePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Lectures in Week'.toUpperCase()),
      ),
      body: Column(
